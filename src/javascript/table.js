...
com.sweattrails.api.TableBuilder.prototype.process = function(t) {
    ...
    table.onrender = t.getAttribute("onrender") && getfunc(t.getAttribute("onrender"))
    table.onrendered = t.getAttribute("onrendered") && getfunc(t.getAttribute("onrendered"))
...
com.sweattrails.api.Image.prototype.render = function() {
    ...
    if (this.alttext != null) img.alt = this.alttext
    return img
}
